...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> HOTGO = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(JavaFinal.MOD_ID, "hotgo"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.HOTGO_SMITHING_TEMPLATE, HOTGO);
    }
