...
public class SkineaterAnimations {
    public static final AnimationDefinition ANIM_SKINEATER_IDLE = AnimationDefinition.Builder.withLength(2.0F).looping()
    ...
    public static final AnimationDefinition ANIM_SKINEATER_WALK = AnimationDefinition.Builder.withLength(5.0F).looping()
