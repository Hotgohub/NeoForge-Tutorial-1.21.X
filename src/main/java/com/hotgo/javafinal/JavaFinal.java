...
import com.hotgo.javafinal.entity.client.*;
...
@Mod(JavaFinal.MOD_ID)
public class JavaFinal {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "javafinal";
    ...
    public JavaFinal(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = JavaFinal.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
