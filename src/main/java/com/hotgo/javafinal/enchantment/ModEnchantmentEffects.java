package com.hotgo.javafinal.enchantment;

import com.hotgo.javafinal.JavaFinal;
import com.hotgo.javafinal.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantmentEffects {
    public static final DeferredRegister<MapCodec<? extends EnchantmentEntityEffect>> ENTITY_ENCHANTMENT_EFFECTS =
            DeferredRegister.create(Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE, JavaFinal.MOD_ID);
